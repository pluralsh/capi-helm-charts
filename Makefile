CORE_VERSION=v1.4.5# renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api
CONTROL_PLANE_VERSION=v1.4.5# renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api
BOOTSTRAP_VERSION=v1.4.5# renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api
