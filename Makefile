CORE_VERSION=v1.6.2# renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api
CONTROL_PLANE_VERSION=v1.6.2# renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api
BOOTSTRAP_VERSION=v1.6.2# renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api
...
AZURE_VERSION=v1.14.0# renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api-provider-azure
