CORE_VERSION=v1.6.1# renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api
CONTROL_PLANE_VERSION=v1.6.1# renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api
...
AZURE_VERSION=v1.12.1# renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api-provider-azure
