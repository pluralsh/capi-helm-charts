CORE_VERSION=v1.6.3# renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api
CONTROL_PLANE_VERSION=v1.6.3# renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api
BOOTSTRAP_VERSION=v1.6.3# renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api
DOCKER_VERSION=v1.6.3# renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api
